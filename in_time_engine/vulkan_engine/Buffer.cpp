...
namespace it {
	...
	// Functions
	uint32_t Vulkan::Buffer::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
	...
	Vulkan::Buffer::Buffer(const VkBufferCreateInfo& createInfo) {
		create(createInfo);
	}
	Vulkan::Buffer::Buffer(const VkBufferCreateInfo& createInfo, void* data, size_t dataOffset, size_t dataSize) {
		create(createInfo, data, dataOffset, dataSize);
	}
	Vulkan::Buffer::Buffer(const VkBufferCreateInfo& createInfo, void* data, size_t dataOffset, size_t dataSize, VkMemoryPropertyFlags memoryPropertyFlags) {
	...
	// Functions
	bool Vulkan::Buffer::isCreated() const {
		return buffer == nullptr ? false : true;
	}
	bool Vulkan::Buffer::create(const VkBufferCreateInfo& createInfo) {
		return create(createInfo, nullptr, 0ULL, 0ULL);
	}
	bool Vulkan::Buffer::create(const VkBufferCreateInfo& createInfo, void* data, size_t dataOffset, size_t dataSize) {
	...
	bool Vulkan::Buffer::create(const VkBufferCreateInfo& createInfo, void* data, size_t dataOffset, size_t dataSize, VkMemoryPropertyFlags memoryPropertyFlags) {
