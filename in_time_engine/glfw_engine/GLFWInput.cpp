...
namespace glfw {
	...
	int Input::getKeyIndex(KeyCode keyCode) {
	...
	MouseButton Input::getMouseButton(MouseButtonCode mouseButtonCode) {
		// Mouse button index
	...
	int Input::getMouseButtonIndex(MouseButtonCode mouseButtonCode) {
