...
namespace gl {
	...
	// Functions | Helper
	int Program::getElementCount(GLenum openGLType) {
		switch (openGLType) {
			// Scalar
		case GL_BOOL:
		case GL_INT:
	...
	int Program::getElementCount(DataType dataType) {
		switch (dataType) {
			// Scalar
		case DataType::BOOL:
		case DataType::INT:
	...
	DataType Program::getBaseType(DataType dataType) {
		switch (dataType) {
			// bool
		case DataType::BOOL:
		case DataType::BOOL_VEC2:
	...
	int Program::getDataTypeSize(DataType dataType) {
		switch (dataType) {
			// Scalars
		case DataType::BOOL:
			return sizeof(bool);
	...
	std::vector<Attribute> Program::getAttributes() const {
		return attributes;
	}
	std::vector<Uniform> Program::getUniforms() const {
		return uniforms;
	}
	std::vector<ShaderStorageBuffer> Program::getSSBOs() const {
		return ssbos;
	}
	...
	bool Program::link(const std::initializer_list<unsigned int>& shaderIds) {
		...
		int linkResult = 0;
		glGetProgramiv(id, GL_LINK_STATUS, reinterpret_cast<int*>(&linkResult));
	...
	bool Program::link(const std::initializer_list<Shader*>& shaders) {
		// Free resources if allocated
		free();
	...
	void Program::updateUniforms() {
		...
		for (int i = 0; i < activeUniformLocations; i++) {
			...
			uniforms[i].dataType = (DataType)dataType;
	...
	void Program::updateUniformBlocks() {
		...
		for (int i = 0; i < activeUniformBlocks; i++) {
			...
			uniformBlocks[i].variables = std::vector<UniformBlockData>(numberOfVariables);
	...
	void Program::setUniform(int location, const glm::ivec2& value) const {
		glUniform2i(location, value[0], value[1]);
	}
	void Program::setUniform(int location, const glm::uvec2& value) const {
		glUniform2ui(location, value[0], value[1]);
	}
	void Program::setUniform(int location, const glm::vec2& value) const {
		glUniform2f(location, value[0], value[1]);
	}
	void Program::setUniform(int location, const glm::ivec3& value) const {
		glUniform3i(location, value[0], value[1], value[2]);
	}
	void Program::setUniform(int location, const glm::uvec3& value) const {
		glUniform3ui(location, value[0], value[1], value[2]);
	}
	void Program::setUniform(int location, const glm::vec3& value) const {
		glUniform3f(location, value[0], value[1], value[2]);
	}
	void Program::setUniform(int location, const glm::ivec4& value) const {
		glUniform4i(location, value[0], value[1], value[2], value[3]);
	}
	void Program::setUniform(int location, const glm::uvec4& value) const {
		glUniform4ui(location, value[0], value[1], value[2], value[3]);
	}
	void Program::setUniform(int location, const glm::vec4& value) const {
		glUniform4f(location, value[0], value[1], value[2], value[3]);
	}

	void Program::setUniform(int location, int count, const int data[]) const {
		glUniform1iv(location, count, data);
	}
	void Program::setUniform(int location, int count, const glm::ivec2 data[]) const {
		glUniform2iv(location, count, reinterpret_cast<const int*>(data));
	}
	void Program::setUniform(int location, int count, const glm::ivec3 data[]) const {
		glUniform3iv(location, count, reinterpret_cast<const int*>(data));
	}
	void Program::setUniform(int location, int count, const glm::ivec4 data[]) const {
		glUniform4iv(location, count, reinterpret_cast<const int*>(data));
	}
	void Program::setUniform(int location, int count, const unsigned int data[]) const {
		glUniform1uiv(location, count, data);
	}
	void Program::setUniform(int location, int count, const glm::uvec2 data[]) const {
		glUniform2uiv(location, count, reinterpret_cast<const unsigned int*>(data));
	}
	void Program::setUniform(int location, int count, const glm::uvec3 data[]) const {
		glUniform3uiv(location, count, reinterpret_cast<const unsigned int*>(data));
	}
	void Program::setUniform(int location, int count, const glm::uvec4 data[]) const {
		glUniform4uiv(location, count, reinterpret_cast<const unsigned int*>(data));
	}
	void Program::setUniform(int location, int count, const float data[]) const {

		glUniform1fv(location, count, data);
	}
	void Program::setUniform(int location, int count, const glm::vec2 data[]) const {
		glUniform2fv(location, count, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, const glm::vec3 data[]) const {
		glUniform3fv(location, count, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, const glm::vec4 data[]) const {
		glUniform4fv(location, count, reinterpret_cast<const float*>(data));
	}

	void Program::setUniform(int location, int count, bool transpose, const glm::mat2 data[]) const {
		glUniformMatrix2fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat2x3 data[]) const {
		glUniformMatrix2x3fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat2x4 data[]) const {
		glUniformMatrix2x4fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat3 data[]) const {
		glUniformMatrix3fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat3x2 data[]) const {
		glUniformMatrix3x2fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat3x4 data[]) const {
		glUniformMatrix3x4fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat4 data[]) const {
		glUniformMatrix4fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat4x2 data[]) const {
		glUniformMatrix4x2fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setUniform(int location, int count, bool transpose, const glm::mat4x3 data[]) const {
		glUniformMatrix4x3fv(location, count, transpose, reinterpret_cast<const float*>(data));
	}

	void Program::setProgramUniform(int location, int value) const {
		glProgramUniform1i(id, location, value);
	}
	void Program::setProgramUniform(int location, unsigned int value) const {
		glProgramUniform1ui(id, location, value);
	}
	void Program::setProgramUniform(int location, float value) const {
		glProgramUniform1f(id, location, value);
	}
	void Program::setProgramUniform(int location, const glm::ivec2& value) const {
		glProgramUniform2i(id, location, value[0], value[1]);
	}
	void Program::setProgramUniform(int location, const glm::uvec2& value) const {
		glProgramUniform2ui(id, location, value[0], value[1]);
	}
	void Program::setProgramUniform(int location, const glm::vec2& value) const {
		glProgramUniform2f(id, location, value[0], value[1]);
	}
	void Program::setProgramUniform(int location, const glm::ivec3& value) const {
		glProgramUniform3i(id, location, value[0], value[1], value[2]);
	}
	void Program::setProgramUniform(int location, const glm::uvec3& value) const {
		glProgramUniform3ui(id, location, value[0], value[1], value[2]);
	}
	void Program::setProgramUniform(int location, const glm::vec3& value) const {
		glProgramUniform3f(id, location, value[0], value[1], value[2]);
	}
	void Program::setProgramUniform(int location, const glm::ivec4& value) const {
		glProgramUniform4i(id, location, value[0], value[1], value[2], value[3]);
	}
	void Program::setProgramUniform(int location, const glm::uvec4& value) const {
		glProgramUniform4ui(id, location, value[0], value[1], value[2], value[3]);
	}
	void Program::setProgramUniform(int location, const glm::vec4& value) const {
		glProgramUniform4f(id, location, value[0], value[1], value[2], value[3]);
	}

	void Program::setProgramUniform(int location, int count, const int data[]) const {
		glProgramUniform1iv(id, location, count, data);
	}
	void Program::setProgramUniform(int location, int count, const glm::ivec2 data[]) const {
		glProgramUniform2iv(id, location, count, reinterpret_cast<const int*>(data));
	}
	void Program::setProgramUniform(int location, int count, const glm::ivec3 data[]) const {
		glProgramUniform3iv(id, location, count, reinterpret_cast<const int*>(data));
	}
	void Program::setProgramUniform(int location, int count, const glm::ivec4 data[]) const {
		glProgramUniform4iv(id, location, count, reinterpret_cast<const int*>(data));
	}
	void Program::setProgramUniform(int location, int count, const unsigned int data[]) const {
		glProgramUniform1uiv(id, location, count, data);
	}
	void Program::setProgramUniform(int location, int count, const glm::uvec2 data[]) const {
		glProgramUniform2uiv(id, location, count, reinterpret_cast<const unsigned int*>(data));
	}
	void Program::setProgramUniform(int location, int count, const glm::uvec3 data[]) const {
		glProgramUniform3uiv(id, location, count, reinterpret_cast<const unsigned int*>(data));
	}
	void Program::setProgramUniform(int location, int count, const glm::uvec4 data[]) const {
		glProgramUniform4uiv(id, location, count, reinterpret_cast<const unsigned int*>(data));
	}
	void Program::setProgramUniform(int location, int count, const float data[]) const {
		glProgramUniform1fv(id, location, count, data);
	}
	void Program::setProgramUniform(int location, int count, const glm::vec2 data[]) const {
		glProgramUniform2fv(id, location, count, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, const glm::vec3 data[]) const {
		glProgramUniform3fv(id, location, count, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, const glm::vec4 data[]) const {
		glProgramUniform4fv(id, location, count, reinterpret_cast<const float*>(data));
	}

	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat2 data[]) const {
		glProgramUniformMatrix2fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat2x3 data[]) const {
		glProgramUniformMatrix2x3fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat2x4 data[]) const {
		glProgramUniformMatrix2x4fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat3 data[]) const {
		glProgramUniformMatrix3fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat3x2 data[]) const {
		glProgramUniformMatrix3x2fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat3x4 data[]) const {
		glProgramUniformMatrix3x4fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat4 data[]) const {
		glProgramUniformMatrix4fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat4x2 data[]) const {
		glProgramUniformMatrix4x2fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}
	void Program::setProgramUniform(int location, int count, bool transpose, const glm::mat4x3 data[]) const {
		glProgramUniformMatrix4x3fv(id, location, count, transpose, reinterpret_cast<const float*>(data));
	}

	// Function | Attribute
	void Program::enableAttribute(unsigned int index) const {
		glEnableVertexAttribArray(index);
	}
	void Program::disableAttribute(unsigned int index) const {
	...
	void Program::setAttributeFormat(unsigned int attributeLocation, int elementCount, DataType dataType, bool normalized, unsigned int relativeOffset) const {
		glVertexAttribFormat(attributeLocation, elementCount, (GLenum)dataType, normalized, relativeOffset);
	}
	void Program::setAttributeIFormat(unsigned int attributeLocation, int elementCount, DataType dataType, unsigned int relativeOffset) const {
		glVertexAttribIFormat(attributeLocation, elementCount, (GLenum)dataType, relativeOffset);
	}
	void Program::setAttributeLFormat(unsigned int attributeLocation, int elementCount, DataType dataType, unsigned int relativeOffset) const {
		glVertexAttribLFormat(attributeLocation, elementCount, (GLenum)dataType, relativeOffset);
	}
	void Program::autoSetAttributeFormat() {
	...
	void Program::setAttributeBinding(unsigned int attributeLocation, unsigned int bindingIndex) const {
		glVertexAttribBinding(attributeLocation, bindingIndex);
	}
	void Program::autoSetAttributeBinding(unsigned int bindingIndex) const {
		for (const Attribute& attribute : attributes)
