...
// Dependencies | in_time_engine
#include <glfw_engine/GLFWWindow.h>
...
namespace it {
	class CameraControl2D : public UpdateEvent {
		...
		public:
			...
			float translationStrength = -0.25f;
			float zoomStrength = 20.0f;
			...
			void onPreUpdate() override {
				...
				glfw::Window* windowWrapper = (glfw::Window*)glfwGetWindowUserPointer(camera2D->camera2D.renderTarget);
