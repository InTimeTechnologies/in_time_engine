...
namespace gtc
{
	...
	*/
	...
	GLM_FUNC_QUALIFIER T simplex(glm::vec<2, T, Q> const& v)
	{
		...
		// The ring radius 17*17 = 289 is close to a multiple of 41 (41*7 = 287)
	...
	GLM_FUNC_QUALIFIER T simplex(vec<3, T, Q> const& v)
	{
		...
		// The ring radius 17*17 = 289 is close to a multiple of 49 (49*6 = 294)
	...
	GLM_FUNC_QUALIFIER T simplex(vec<4, T, Q> const& v)
	{
		...
		// 7*7*6 = 294, which is close to the ring radius 17*17 = 289.
