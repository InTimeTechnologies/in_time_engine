...
REM check if glfw build stamp exist
...
if exist "%BUILD_STAMP_PATH%" (
	echo skipping glfw build reason: detected build stamp: %BUILD_STAMP_PATH%
	exit /b 0
)
...
REM assert CMakeLists.txt exists in DEPENDENCY_DIR
